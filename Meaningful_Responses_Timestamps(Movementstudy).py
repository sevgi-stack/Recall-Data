...
# Load the Excel file
file_path = 'Meaningful_Responses_Timestamps(Movementstudy).xlsx'  # Replace with your actual file path
...
output_file_path = 'Meaningful_Responses_transformed_data.xlsx'  # Specify your desired output file path
